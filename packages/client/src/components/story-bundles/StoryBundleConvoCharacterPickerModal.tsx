...
export function StoryBundleConvoCharacterPickerModal({
  ...
  const [selectedCharacterId, setSelectedCharacterId] = useState<string | null>(defaultCharacterId);
    ...
    >
      <div className="flex flex-col gap-3 p-4">
        <p className="text-xs text-[var(--muted-foreground)]">
          {t("storyBundles.whoToMessageHint", "Pick which of this bundle's characters to start a conversation with.")}
        </p>
        ...
        <div className="mt-1 flex justify-end gap-2">
          ...
          <button
            ...
            onClick={() => onConfirm(selectedCharacterId)}
            disabled={isConfirming || !selectedCharacterId}
