...
addPersona, addPresets, agentRandomHint, agentsEmpty, allAdded, allAgentsAdded,
allCharactersAdded, allLorebooksAdded, allPresetsAdded, back, cancel,
...
noPersonasAvailable, noPersonasMatch, noPresetsMatch, of, personaAlreadySelected,
personaEmpty, personaRandomHint, play, playFailed, playStarted, playTitle,
presetRandomHint, presetsEmpty, random, randomHint, removeAgent, removeCharacter,
...
selectedPersona, selectedPresets, skipEmbedded) and the `storyBundles.metadata.*`
